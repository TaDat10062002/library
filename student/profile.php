...
<body>
                ...
                <div class="span9">
                    <div class="module">
                        ...
                        <div class="module-body">
                            ...
                            $sql = "select * from thuvien.user where RollNo='$rollno'";
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql1 = "update thuvien.user set Name='$name', Category='$category', EmailId='$email', MobNo='$mobno', Password='$pswd' where RollNo='$rollno'";
