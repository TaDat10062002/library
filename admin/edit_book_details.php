...
?>
    ...
    <body>
                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <?php
                                $bookid = $_GET['id'];
                                $sql = "select * from thuvien.book where Bookid='$bookid'";
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql1 = "update thuvien.book set Title='$name', Publisher='$publisher', Year='$year', Availability='$avail' where BookId='$bookid'";
