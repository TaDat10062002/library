                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id="tables">
                            ...
                            <tbody>
                                <?php
                                $sql = "select return.BookId,return.RollNo,Title,datediff(curdate(),Due_Date) as x from thuvien.return,thuvien.book,thuvien.record where return.BookId=book.BookId and return.BookId=record.BookId and return.RollNo=record.RollNo";
