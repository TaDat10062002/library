                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        if (isset($_POST['submit'])) {
                            $s = $_POST['title'];
                            $sql = "select * from thuvien.record,thuvien.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId and (record.BookId='$s' or Title like '%$s%')";
                        } else
                            $sql = "select * from thuvien.record,thuvien.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId";
