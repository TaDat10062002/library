...
<body>
    ...
    if (isset($_POST['signin'])) {
        ...
        $sql = "select * from thuvien.user where RollNo='$u'";
    ...
    if (isset($_POST['signup'])) {
        ...
        $sql = "insert into thuvien.user (Name,Type,Category,RollNo,EmailId,MobNo,Password) values ('$name','$type','$category','$rollno','$email','$mobno','$password')";
