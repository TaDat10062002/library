                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id="tables">
                            ...
                            <tbody>
                                <?php
                                $sql = "select * from thuvien.record,thuvien.book,thuvien.renew where renew.BookId=book.BookId and renew.RollNo=record.RollNo and renew.BookId=record.BookId";
